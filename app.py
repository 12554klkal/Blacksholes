...
# -------------------------
tab1, tab2, tab3 = st.tabs(["Black-Scholes Calculator", "Volatility & P&L Analysis", "Financial Terms Explained"]) # Removed Option Greeks tab
...
# Removed the entire 'with tab2:' block for Option Greeks

with tab2: # This is now the Volatility & P&L Analysis tab
    ...
    st.markdown("---")
    # Removed the Interactive Greeks Plots vs. Stock Price section completely.


with tab3: # This is now the Financial Terms Explained tab
